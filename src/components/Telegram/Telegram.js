  ...
  return (
    <div>
      ...
      <div className={styles.botGroup}>
        <h2>Add Bot To Group</h2>
      </div>
      <div className={styles.manual}>
        <h2>Manual:</h2>
        <ol>
          <li>1. Open the telegram app.</li>
          <li>2. Open the group you want to add the bot to.</li>
          <li>3. Click on add members in group settings.</li>
          <li>4. Search @HodlInfoBot and click it.</li>
        </ol>
      </div>
      <div className={styles.auto}>
        ...
        <p>
          {" "}
          Go To :{" "}
          <a href=" https://t.me/HodlInfoBot?startgroup=true">
            {" "}
      ...
      <div className={styles.manual}>
        ...
        <ol>
          <li>1. Open the telegram app.</li>
          <li>2. Click on new message button.</li>
          <li>3. In search bar type HodlInfoBot.</li>
          <li>4. Click on @HodlInfoBot.</li>
        </ol>
      </div>
      <div className={styles.auto}>
        <h2>Automatic:</h2>
        <p>
          {" "}
          Go To :{" "}
          <a href=" https://t.me/HodlInfoBot"> https://t.me/HodlInfoBot</a>
        </p>
      </div>
    </div>
  );
